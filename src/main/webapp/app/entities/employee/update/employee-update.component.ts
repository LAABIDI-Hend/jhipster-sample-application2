...
export class EmployeeUpdateComponent implements OnInit {
  ...
  birthdaysSharedCollection: IBirthday[] = [];
  ...
  compareBirthday = (o1: IBirthday | null, o2: IBirthday | null): boolean => this.birthdayService.compareBirthday(o1, o2);
  ...
  protected updateForm(employee: IEmployee): void {
    ...
    this.birthdaysSharedCollection = this.birthdayService.addBirthdayToCollectionIfMissing<IBirthday>(
      this.birthdaysSharedCollection,
      employee.birthday
    );
  }
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.birthdayService
      .query()
      .pipe(map((res: HttpResponse<IBirthday[]>) => res.body ?? []))
      .pipe(
        map((birthdays: IBirthday[]) =>
          this.birthdayService.addBirthdayToCollectionIfMissing<IBirthday>(birthdays, this.employee?.birthday)
        )
      )
      .subscribe((birthdays: IBirthday[]) => (this.birthdaysSharedCollection = birthdays));
  }
}
